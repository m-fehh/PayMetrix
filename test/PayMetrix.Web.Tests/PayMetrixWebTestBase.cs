...
using PayMetrix.Models.TokenAuth;
...
{
    public abstract class PayMetrixWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PayMetrixWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PayMetrixWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PayMetrixDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PayMetrixDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PayMetrixDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PayMetrixDbContext, Task<T>> func)
        {
            T result;
